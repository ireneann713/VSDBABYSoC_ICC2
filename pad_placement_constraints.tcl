...
create_io_guide -side right -pad_cells {analog_out_sel_buf  comp_ena_buf comp_in_buf ext_clk_buf ext_clk_sel_buf ext_reset_buf flash_clk_buf flash_csb_buf} -line {{1701 1402} 1101}
