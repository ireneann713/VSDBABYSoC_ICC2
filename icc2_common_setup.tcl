...
##########################################################################################
set DESIGN_NAME 		"rvmyth" ;# Required; name of the design to be worked on; also used as the block name when scripts save or copy a block
...
set REFERENCE_LIBRARY 		[list /home/irene/workshop/icc2_workshop/nangate_stdcell.lef /home/irene/workshop/icc2_workshop/sram/sram_32_1024_freepdk45.lef]	;# Required; a list of reference libraries for the design library.
...
#set VERILOG_NETLIST_FILES      "/home/irene/workshop/icc2_workshop/pnrScripts/spi_slave.synth.v"
set VERILOG_NETLIST_FILES	"/home/irene/workshop/icc2_workshop/report/rvmyth.v"	;# Verilog netlist files;
					;# 	for DP: required
...
set TCL_PARASITIC_SETUP_FILE	"/home/irene/workshop/icc2_workshop/standaloneFlow/init_design.read_parasitic_tech_example.tcl"	;# Specify a Tcl script to read in your TLU+ files by using the read_parasitic_tech command;
					;# refer to the example in templates/init_design.read_parasitic_tech_example.tcl 

#set TCL_MCMM_SETUP_FILE         ""
set TCL_MCMM_SETUP_FILE		"/home/irene/workshop/icc2_workshop/standaloneFlow/init_design.mcmm_example.auto_expanded.tcl"	;# Specify a Tcl script to create your corners, modes, scenarios and load respective constraints;
...
set TECH_FILE 			"/home/irene/workshop/icc2_workshop/nangate.tf" 	;# A technology file; TECH_FILE and TECH_LIB are mutually exclusive ways to specify technology information; 
...
#set DEF_FLOORPLAN_FILES		"/home/irene/design/scripts/pnr/ICC2-RM_P-2019.03-SP4/write_data_dir/picorv32/picorv32.icc.floorplan/floorplan.def.gz"	;# DEF files which contain the floorplan information;
...
set LINK_LIBRARY		[list /home/irene/workshop/icc2_workshop/nangate_typical.db /home/irene/workshop/icc2_workshop/sram_32_1024_freepdk45_TT_1p0V_25C_lib.db]	;# Specify .db files;
...
set RELEASE_DIR_DP		"write_data_dir_hier" 	;# Specify the release directory of DP RM; 
					...
					;#	for DP: not used 
set RELEASE_LABEL_NAME_DP 	"rvmyth_nangate"	
